...
export async function POST(request: NextRequest) {
  try {
    ...
    const paymentIntent = await createPaymentIntent(
      ...
      undefined, // application fee
      recipient.stripeAccountId ? { destination: recipient.stripeAccountId } : undefined
    )
    ...
    const payment = await prisma.payment.create({
      data: {
        ...
        description: description || `Payment to ${recipient.name || recipient.email}`,
